...
export default class NewsListComponent implements OnInit {
  ...
  applyFilters() {
    ...
    this.filteredNews = list.slice(start, start + this.pageSize)
  }
  ...
  goToPage(page: number) {
    ...
    this.currentPage = page; this.applyFilters()
  }

  goToDetail(id: string | number) { this.router.navigate(['/news', id]) }
